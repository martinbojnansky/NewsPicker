...
namespace NewsPicker.Api
{
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion(ApiConstants.VERSION, "NewsPicker.Api");
                    ...
                    //    (vc) =>
                    //    {
                    //        vc.Version("client", "TopNews.Mobile.Api");
                    //        vc.Version("admin", "NewsPicker.Api");
                    //    });
                    ...
                    // Operation filters.
                    //
                    c.OperationFilter<OperationControllerNameFilter>();
                    //
                    ...
                    // ***** Uncomment the following to enable the swagger UI *****
                        ...
                        .EnableSwaggerUi(c =>
                        {
                            ...
                            c.InjectJavaScript(thisAssembly, "NewsPicker.Api.Resources.Scripts.swagger_apikey.js");
        ...
        //{
        //    var versionConstraint = apiDesc.Route.RouteTemplate.Split('/')[1];

        //    return string.Compare(versionConstraint, targetApiVersion, StringComparison.InvariantCultureIgnoreCase) == 0;
        //}
    }
    ...
    internal class OperationControllerNameFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
